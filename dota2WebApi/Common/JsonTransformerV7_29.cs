...
{
    public class JsonTransformerV7_29Creator : AbstractJsonTransformerCreator
    {
        private JsonTransformerV7_29 _instance;
        public override AbstractJsonTransformer FactoryMethod()
        {
            if (_instance == null)
                _instance = new JsonTransformerV7_29();
            return _instance;
        }
    }

    public class JsonTransformerV7_29 : AbstractJsonTransformer
    {
        internal JsonTransformerV7_29() { }
